...
class Predictor(object):
    ...
    def get_model_names(user_defined_model_names=None):
        gs_param_model_names = {}
        ...
        gs_param_model_names['final_model__model'] = final_model__models
        return gs_param_model_names
    ...
    def perform_grid_search_by_model_names(self, estimator_names, scoring, X_df, y):
        ...
        for model_name in estimator_names:
            ...
            self.grid_search_params = self.get_model_names(user_defined_model_names=estimator_names)
